                ...
                <div id="myModal1" className="modal">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <button className="btn btn-danger mx-1" onClick={hideModal}>Save Changes</button>
