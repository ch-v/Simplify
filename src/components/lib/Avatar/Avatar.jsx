...
export const Avatar = () => {
    return (
        <ComponentBox>
            <h1>Avatars</h1>
            <p className="txt-primary mt-10">Avatar is used to represent a user, and displays the profile picture, initials or fallback icon.   </p>
            <h2 className="mt-20">Image Avatars</h2>
            <div className="flex flex-wrap mt-20 component-box">
