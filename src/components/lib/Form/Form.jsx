...
export const Form = () => {
    return (
        <ComponentBox>
            <h1>Form</h1>
            <p className="txt-primary mt-10">Forms are used to take input from the user for a variety of purposes like feedback, orders and more.</p>
            <h2 className="mt-20">Input</h2>
            <div className="flex flex-wrap flex-between mt-20">
